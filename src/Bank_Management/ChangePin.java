...
public class ChangePin extends JFrame implements ActionListener
{
	...
	ChangePin(String pinnumber)
	{
		...
		heading.setBounds(280,230,250,40);
		...
		newpin.setBounds(180,300,250,30);
		imglabel.add(newpin);
